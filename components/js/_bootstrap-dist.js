!function(t, e) {
    ...
    function g(t, e, n, i) {
        var o, r = 1, s = 20, a = i ? function() {
            ...
            return gt.css(t, e, "");
        }, l = a(), u = n && n[3] || (gt.cssNumber[e] ? "" : "px"), c = (gt.cssNumber[e] || "px" !== u && +l) && Wt.exec(gt.css(t, e));
        if (c && c[3] !== u) {
            u = u || c[3], n = n || [], c = +l || 1;
            do {
                r = r || ".5", c /= r, gt.style(t, e, c + u);
            } while (r !== (r = a() / l) && 1 !== r && --s);
        }
    ...
    function m(t) {
        ...
        return o || (e = n.body.appendChild(n.createElement(i)), o = gt.css(e, "display"), 
        e.parentNode.removeChild(e), "none" === o && (o = "block"), _t[i] = o, o);
    }
    function v(t, e) {
        for (var n, i, o = [], r = 0, s = t.length; r < s; r++) (i = t[r]).style && (n = i.style.display, 
        e ? ("none" === n && (o[r] = Rt.get(i, "display") || null, o[r] || (i.style.display = "")), 
        "" === i.style.display && Bt(i) && (o[r] = m(i))) : "none" !== n && (o[r] = "none", 
        Rt.set(i, "display", n)));
    ...
    function x(t, e, n, i, o) {
        for (var r, s, a, l, u, c, f = e.createDocumentFragment(), p = [], d = 0, h = t.length; d < h; d++) if ((r = t[d]) || 0 === r) if ("object" === gt.type(r)) gt.merge(p, r.nodeType ? [ r ] : r); else if (Gt.test(r)) {
            for (s = s || f.appendChild(e.createElement("div")), a = (Vt.exec(r) || [ "", "" ])[1].toLowerCase(), 
            l = Qt[a] || Qt._default, s.innerHTML = l[1] + gt.htmlPrefilter(r) + l[2], c = l[0]; c--; ) s = s.lastChild;
            gt.merge(p, s.childNodes), (s = f.firstChild).textContent = "";
        } else p.push(e.createTextNode(r));
        for (f.textContent = "", d = 0; r = p[d++]; ) if (i && gt.inArray(r, i) > -1) o && o.push(r); else if (u = gt.contains(r.ownerDocument, r), 
        s = y(f.appendChild(r), "script"), u && b(s), n) for (c = 0; r = s[c++]; ) Xt.test(r.type || "") && n.push(r);
        return f;
    }
    function w() {
        return !0;
    ...
    function E(t, e, n, i, o, r) {
        ...
        i = void 0) : (o = i, i = n, n = void 0)), !1 === o) o = T; else if (!o) return t;
    ...
    function D(t, e) {
        ...
        if (1 === e.nodeType) {
            if (Rt.hasData(t) && (r = Rt.access(t), s = Rt.set(e, r), u = r.events)) {
                ...
                for (o in u) for (n = 0, i = u[o].length; n < i; n++) gt.event.add(e, o, u[o][n]);
            }
            qt.hasData(t) && (a = qt.access(t), l = gt.extend({}, a), qt.set(e, l));
        }
    }
    function N(t, e) {
    ...
    function A(t, e, i, o) {
        e = rt.apply([], e);
        var r, s, a, l, u, c, f = 0, p = t.length, d = p - 1, h = e[0], g = gt.isFunction(h);
        if (g || p > 1 && "string" == typeof h && !dt.checkClone && ne.test(h)) return t.each(function(n) {
            var r = t.eq(n);
            g && (e[0] = h.call(this, n, r.html())), A(r, e, i, o);
        });
        if (p && (r = x(e, t[0].ownerDocument, !1, t, o), s = r.firstChild, 1 === r.childNodes.length && (r = s), 
        s || o)) {
            for (l = (a = gt.map(y(r, "script"), $)).length; f < p; f++) u = r, f !== d && (u = gt.clone(u, !0, !0), 
            l && gt.merge(a, y(u, "script"))), i.call(t[f], u, f);
            if (l) for (c = a[a.length - 1].ownerDocument, gt.map(a, k), f = 0; f < l; f++) u = a[f], 
            Xt.test(u.type || "") && !Rt.access(u, "globalEval") && gt.contains(c, u) && (u.src ? gt._evalUrl && gt._evalUrl(u.src) : n(u.textContent.replace(oe, ""), c));
        }
        return t;
    }
    function j(t, e, n) {
        for (var i, o = e ? gt.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || gt.cleanData(y(i)), 
        i.parentNode && (n && gt.contains(i.ownerDocument, i) && b(y(i, "script")), i.parentNode.removeChild(i));
        return t;
    }
    function O(t, e, n) {
        var i, o, r, s, a = t.style;
        return (n = n || ae(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || gt.contains(t.ownerDocument, t) || (s = gt.style(t, e)), 
        !dt.pixelMarginRight() && se.test(s) && re.test(e) && (i = a.width, o = a.minWidth, 
    ...
    function P(t, e, n, i, o) {
        var r, s = 0;
        for (r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0; r < 4; r += 2) "margin" === n && (s += gt.css(t, n + Mt[r], !0, o)), 
        i ? ("content" === n && (s -= gt.css(t, "padding" + Mt[r], !0, o)), "margin" !== n && (s -= gt.css(t, "border" + Mt[r] + "Width", !0, o))) : (s += gt.css(t, "padding" + Mt[r], !0, o), 
        "padding" !== n && (s += gt.css(t, "border" + Mt[r] + "Width", !0, o)));
        return s;
    }
    function H(t, e, n) {
        var i, o = ae(t), r = O(t, e, o), s = "border-box" === gt.css(t, "boxSizing", !1, o);
        return se.test(r) ? r : (i = s && (dt.boxSizingReliable() || r === t.style[e]), 
        "auto" === r && (r = t["offset" + e[0].toUpperCase() + e.slice(1)]), (r = parseFloat(r) || 0) + P(t, e, n || (s ? "border" : "content"), i, o) + "px");
    }
    function F(t, e, n, i, o) {
        return new F.prototype.init(t, e, n, i, o);
    }
    function W() {
        ge && (!1 === nt.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(W) : t.setTimeout(W, gt.fx.interval), 
        gt.fx.tick());
    }
    function M() {
    ...
    function U(t, e, n) {
        for (var i, o = (V.tweeners[e] || []).concat(V.tweeners["*"]), r = 0, s = o.length; r < s; r++) if (i = o[r].call(n, e, t)) return i;
    }
    function _(t, e, n) {
        var i, o, r, s, a, l, u, c, f = "width" in e || "height" in e, p = this, d = {}, h = t.style, g = t.nodeType && Bt(t), m = Rt.get(t, "fxshow");
        n.queue || (null == (s = gt._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, 
        ...
        if ((l = !gt.isEmptyObject(e)) || !gt.isEmptyObject(d)) {
            ...
            null == (u = m && m.display) && (u = Rt.get(t, "display")), "none" === (c = gt.css(t, "display")) && (u ? c = u : (v([ t ], !0), 
            u = t.style.display || u, c = gt.css(t, "display"), v([ t ]))), ("inline" === c || "inline-block" === c && null != u) && "none" === gt.css(t, "float") && (l || (p.done(function() {
                h.display = u;
            }), null == u && (c = h.display, u = "none" === c ? "" : c)), h.display = "inline-block")), 
            n.overflow && (h.overflow = "hidden", p.always(function() {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2];
            })), l = !1;
            for (i in d) l || (m ? "hidden" in m && (g = m.hidden) : m = Rt.access(t, "fxshow", {
                display: u
            }), r && (m.hidden = !g), g && v([ t ], !0), p.done(function() {
                g || v([ t ]), Rt.remove(t, "fxshow");
                for (i in d) gt.style(t, i, d[i]);
            })), l = U(g ? m[i] : 0, i, p), i in m || (m[i] = l.start, g && (l.end = l.start, 
            l.start = 0));
        }
    }
    function z(t, e) {
        var n, i, o, r, s;
        for (n in t) if (i = gt.camelCase(n), o = e[i], r = t[n], Array.isArray(r) && (o = r[1], 
        r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = gt.cssHooks[i]) && "expand" in s) {
            r = s.expand(r), delete t[i];
            for (n in r) n in t || (t[n] = r[n], e[n] = o);
        } else e[i] = o;
    }
    function V(t, e, n) {
        var i, o, r = 0, s = V.prefilters.length, a = gt.Deferred().always(function() {
            delete l.elem;
        }), l = function() {
            if (o) return !1;
            for (var e = he || M(), n = Math.max(0, u.startTime + u.duration - e), i = 1 - (n / u.duration || 0), r = 0, s = u.tweens.length; r < s; r++) u.tweens[r].run(i);
            return a.notifyWith(t, [ u, i, n ]), i < 1 && s ? n : (s || a.notifyWith(t, [ u, 1, 0 ]), 
            a.resolveWith(t, [ u ]), !1);
        }, u = a.promise({
            elem: t,
            props: gt.extend({}, e),
        ...
        for (z(c, u.opts.specialEasing); r < s; r++) if (i = V.prefilters[r].call(u, t, c, u.opts)) return gt.isFunction(i.stop) && (gt._queueHooks(u.elem, u.opts.queue).stop = gt.proxy(i.stop, i)), 
        i;
    ...
    function G(t, e, n, i) {
        ...
        if (Array.isArray(e)) gt.each(e, function(e, o) {
            n || ke.test(t) ? i(t, o) : G(t + "[" + ("object" == typeof o && null != o ? e : "") + "]", o, n, i);
    ...
    function Y(t) {
        return function(e, n) {
            ...
            if (gt.isFunction(n)) for (;i = r[o++]; ) "+" === i[0] ? (i = i.slice(1) || "*", 
    ...
    function tt(t, e, n, i) {
        ...
        !l && i && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = r, r = c.shift()) if ("*" === r) r = l; else if ("*" !== l && l !== r) {
    ...
    var et = [], nt = t.document, it = Object.getPrototypeOf, ot = et.slice, rt = et.concat, st = et.push, at = et.indexOf, lt = {}, ut = lt.toString, ct = lt.hasOwnProperty, ft = ct.toString, pt = ft.call(Object), dt = {}, ht = "3.2.1", gt = function(t, e) {
        return new gt.fn.init(t, e);
    }, mt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, vt = /^-ms-/, yt = /-([a-z])/g, bt = function(t, e) {
    ...
    gt.fn = gt.prototype = {
        ...
        i = t[e], s !== i && (u && i && (gt.isPlainObject(i) || (o = Array.isArray(i))) ? (o ? (o = !1, 
        r = n && Array.isArray(n) ? n : []) : r = n && gt.isPlainObject(n) ? n : {}, s[e] = gt.extend(u, r, i)) : void 0 !== i && (s[e] = i));
        return s;
    }, gt.extend({
        ...
        proxy: function(t, e) {
            var n, i, o;
            if ("string" == typeof e && (n = t[e], e = t, t = n), gt.isFunction(t)) return i = ot.call(arguments, 2), 
            o = function() {
    ...
    var xt = function(t) {
        function e(t, e, n, i) {
            ...
            if (!i && ((e ? e.ownerDocument || e : F) !== j && A(e), e = e || j, I)) {
                if (11 !== h && (l = gt.exec(t))) if (o = l[1]) {
                    ...
                    } else if (d && (s = d.getElementById(o)) && P(e, s) && s.id === o) return n.push(s), 
                    n;
                } else {
        ...
        function p(t, e, n) {
            ...
            return e.first ? function(e, n, o) {
                ...
                } else for (;e = e[i]; ) if (1 === e.nodeType || s) if (f = e[H] || (e[H] = {}), 
                c = f[e.uniqueID] || (f[e.uniqueID] = {}), o && o === e.nodeName.toLowerCase()) e = e[i] || e; else {
        ...
        function g(t, e, n, i, o) {
            for (var r, s = [], a = 0, l = t.length, u = null != e; a < l; a++) (r = t[a]) && (n && !n(r, i, o) || (s.push(r), 
            u && e.push(a)));
            return s;
        }
        ...
        function y(t, n) {
            var o = n.length > 0, r = t.length > 0, s = function(i, s, a, l, u) {
                ...
                if (d += h, o && h !== d) {
                    ...
                    if (i) {
                        if (d > 0) for (;h--; ) m[h] || v[h] || (v[h] = Q.call(l));
                        v = g(v);
                    }
        ...
        var b, x, w, T, C, E, S, $, k, D, N, A, j, O, I, L, R, q, P, H = "sizzle" + 1 * new Date(), F = t.document, W = 0, M = 0, B = n(), U = n(), _ = n(), z = function(t, e) {
            return t === e && (N = !0), 0;
        }, V = {}.hasOwnProperty, X = [], Q = X.pop, G = X.push, Y = X.push, K = X.slice, J = function(t, e) {
        ...
        try {
            Y.apply(X = K.call(F.childNodes), F.childNodes), X[F.childNodes.length].nodeType;
        } catch (t) {
            Y = {
        ...
        x = e.support = {}, C = e.isXML = function(t) {
            ...
            return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, O = j.documentElement, 
            I = !C(j), F !== j && (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", wt, !1) : n.attachEvent && n.attachEvent("onunload", wt)), 
            x.attributes = o(function(t) {
                ...
                t.querySelectorAll("[id~=" + H + "-]").length || L.push("~="), t.querySelectorAll(":checked").length || L.push(":checked"), 
            ...
            e = ht.test(O.compareDocumentPosition), P = e || ht.test(O.contains) ? function(t, e) {
                ...
                1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === j || t.ownerDocument === F && P(F, t) ? -1 : e === j || e.ownerDocument === F && P(F, e) ? 1 : D ? J(D, t) - J(D, e) : 0 : 4 & n ? -1 : 1);
            } : function(t, e) {
                if (t === e) return N = !0, 0;
                    ...
                    return 1 === i && 0 === o ? function(t) {
                        ...
                        if (m) {
                            ...
                            if (h = [ s ? m.firstChild : m.lastChild ], s && y) {
                                for (b = (d = (u = (c = (f = (p = m)[H] || (p[H] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[t] || [])[0] === W && u[1]) && u[2], 
                                p = d && m.childNodes[d]; p = ++d && p && p[g] || (b = d = 0) || h.pop(); ) if (1 === p.nodeType && ++b && p === e) {
                                    c[t] = [ W, d, b ];
                                    break;
                                }
                            } else if (y && (p = e, f = p[H] || (p[H] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), 
                            u = c[t] || [], d = u[0] === W && u[1], b = d), !1 === b) for (;(p = ++d && p && p[g] || (b = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && (f = p[H] || (p[H] = {}), 
                            c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[t] = [ W, b ]), p !== e)); ) ;
        ...
        return c.prototype = w.filters = w.pseudos, w.setFilters = new c(), E = e.tokenize = function(t, n) {
            ...
            for (a = t, l = [], u = w.preFilter; a; ) {
                ...
                for (s in w.filter) !(o = ft[s].exec(a)) || u[s] && !(o = u[s](o)) || (i = o.shift(), 
                r.push({
                    value: i,
                    type: s,
                    matches: o
        ...
        }, x.sortStable = H.split("").sort(z).join("") === H, x.detectDuplicates = !!N, 
        A(), x.sortDetached = o(function(t) {
    ...
    gt.text = xt.getText, gt.isXMLDoc = xt.isXML, gt.contains = xt.contains, gt.escapeSelector = xt.escape;
    ...
    gt.filter = function(t, e, n) {
        ...
        is: function(t) {
            return !!r(this, "string" == typeof t && Ct.test(t) ? gt(t) : t || [], !1).length;
        }
    });
    var $t, kt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (gt.fn.init = function(t, e, n) {
        ...
        if (n = n || $t, "string" == typeof t) {
            ...
            if (i[1]) {
                if (e = e instanceof gt ? e[0] : e, gt.merge(this, gt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : nt, !0)), 
                Et.test(i[1]) && gt.isPlainObject(e)) for (i in e) gt.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this;
            }
    ...
    var Dt = /^(?:parents|prev(?:Until|All))/, Nt = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    gt.fn.extend({
        ...
        closest: function(t, e) {
            ...
            if (!Ct.test(t)) for (;i < o; i++) for (n = this[i]; n && n !== e; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && gt.find.matchesSelector(n, t))) {
                r.push(n);
                break;
            }
        ...
        gt.fn[t] = function(n, i) {
            ...
            return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = gt.filter(i, o)), 
            this.length > 1 && (Nt[t] || gt.uniqueSort(o), Dt.test(t) && o.reverse()), this.pushStack(o);
        };
    });
    var At = /[^\x20\t\r\n\f]+/g;
    gt.Callbacks = function(t) {
        ...
        var e, n, i, o, r = [], s = [], l = -1, u = function() {
            for (o = o || t.once, i = e = !0; s.length; l = -1) for (n = s.shift(); ++l < r.length; ) !1 === r[l].apply(n[0], n[1]) && t.stopOnFalse && (l = r.length, 
            n = !1);
            ...
            remove: function() {
                return gt.each(arguments, function(t, e) {
                    for (var n; (n = gt.inArray(e, r, n)) > -1; ) r.splice(n, 1), n <= l && l--;
                }), this;
            },
            has: function(t) {
            ...
            var n = [ [ "notify", "progress", gt.Callbacks("memory"), gt.Callbacks("memory"), 2 ], [ "resolve", "done", gt.Callbacks("once memory"), gt.Callbacks("once memory"), 0, "resolved" ], [ "reject", "fail", gt.Callbacks("once memory"), gt.Callbacks("once memory"), 1, "rejected" ] ], i = "pending", o = {
                ...
                then: function(e, i, o) {
                        ...
                        return function() {
                            var a = this, c = arguments, f = function() {
                                ...
                                if (!(e < s)) {
                                    ...
                                    f = t && ("object" == typeof t || "function" == typeof t) && t.then, gt.isFunction(f) ? o ? f.call(t, r(s, n, l, o), r(s, n, u, o)) : (s++, 
                                    f.call(t, r(s, n, l, o), r(s, n, u, o), r(s, n, l, n.notifyWith))) : (i !== l && (a = void 0, 
                                    c = [ t ]), (o || n.resolveWith)(a, c));
                                }
                            }, p = o ? f : function() {
                                try {
                                    f();
                                } catch (t) {
                                    gt.Deferred.exceptionHook && gt.Deferred.exceptionHook(t, p.stackTrace), e + 1 >= s && (i !== u && (a = void 0, 
                                    c = [ t ]), n.rejectWith(a, c));
                                }
                            };
                    ...
                    return gt.Deferred(function(t) {
                        n[0][3].add(r(0, t, gt.isFunction(o) ? o : l, t.notifyWith)), n[1][3].add(r(0, t, gt.isFunction(e) ? e : l)), 
    ...
    }), gt.ready.then = Ot.then, "complete" === nt.readyState || "loading" !== nt.readyState && !nt.documentElement.doScroll ? t.setTimeout(gt.ready) : (nt.addEventListener("DOMContentLoaded", f), 
    ...
    var It = function(t, e, n, i, o, r, s) {
        ...
        } else if (void 0 !== i && (o = !0, gt.isFunction(i) || (s = !0), u && (s ? (e.call(t, i), 
    ...
    p.uid = 1, p.prototype = {
        ...
        remove: function(t, e) {
            ...
            if (void 0 !== i) {
                if (void 0 !== e) {
                    Array.isArray(e) ? e = e.map(gt.camelCase) : (e = gt.camelCase(e), e = e in i ? [ e ] : e.match(At) || []), 
                    n = e.length;
                    for (;n--; ) delete i[e[n]];
                }
    ...
    var Rt = new p(), qt = new p(), Pt = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Ht = /[A-Z]/g;
    gt.extend({
        hasData: function(t) {
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (o = qt.get(r), 1 === r.nodeType && !Rt.get(r, "hasDataAttrs"))) {
                    for (n = s.length; n--; ) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = gt.camelCase(i.slice(5)), 
                    h(r, i, o[i]));
        ...
        queue: function(t, e, n) {
            var i;
            if (t) return e = (e || "fx") + "queue", i = Rt.get(t, e), n && (!i || Array.isArray(n) ? i = Rt.access(t, e, gt.makeArray(n)) : i.push(n)), 
            i || [];
        },
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--; ) (n = Rt.get(r[s], t + "queueHooks")) && n.empty && (i++, 
            n.empty.add(a));
            return a(), o.promise(e);
        }
    });
    var Ft = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Wt = new RegExp("^(?:([+-])=|)(" + Ft + ")([a-z%]*)$", "i"), Mt = [ "Top", "Right", "Bottom", "Left" ], Bt = function(t, e) {
    ...
    var Gt = /<|&#?\w+;/;
    !function() {
        var t = nt.createDocumentFragment().appendChild(nt.createElement("div")), e = nt.createElement("input");
    ...
    var Yt = nt.documentElement, Kt = /^key/, Jt = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Zt = /^([^.]*)(?:\.(.+)|)/;
    gt.event = {
        global: {},
        add: function(t, e, n, i, o) {
            var r, s, a, l, u, c, f, p, d, h, g, m = Rt.get(t);
            if (m) for (n.handler && (r = n, n = r.handler, o = r.selector), o && gt.find.matchesSelector(Yt, o), 
            n.guid || (n.guid = gt.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                return void 0 !== gt && gt.event.triggered !== e.type ? gt.event.dispatch.apply(t, arguments) : void 0;
            }), u = (e = (e || "").match(At) || [ "" ]).length; u--; ) a = Zt.exec(e[u]) || [], 
            d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = gt.event.special[d] || {}, 
            d = (o ? f.delegateType : f.bindType) || d, f = gt.event.special[d] || {}, c = gt.extend({
                type: d,
                origType: g,
                data: i,
                handler: n,
                ...
                namespace: h.join(".")
            }, r), (p = l[d]) || (p = l[d] = [], p.delegateCount = 0, f.setup && !1 !== f.setup.call(t, i, h, s) || t.addEventListener && t.addEventListener(d, s)), 
            f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, c) : p.push(c), 
            gt.event.global[d] = !0);
        },
        remove: function(t, e, n, i, o) {
            var r, s, a, l, u, c, f, p, d, h, g, m = Rt.hasData(t) && Rt.get(t);
            if (m && (l = m.events)) {
                for (u = (e = (e || "").match(At) || [ "" ]).length; u--; ) if (a = Zt.exec(e[u]) || [], 
                d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                    for (f = gt.event.special[d] || {}, p = l[d = (i ? f.delegateType : f.bindType) || d] || [], 
                    a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--; ) c = p[r], 
                    !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(r, 1), 
                    c.selector && p.delegateCount--, f.remove && f.remove.call(t, c));
                    s && !p.length && (f.teardown && !1 !== f.teardown.call(t, h, m.handle) || gt.removeEvent(t, d, m.handle), 
                    delete l[d]);
                } else for (d in l) gt.event.remove(t, d + e[u], n, i, !0);
                gt.isEmptyObject(l) && Rt.remove(t, "handle events");
            }
        },
        dispatch: function(t) {
            var e, n, i, o, r, s, a = gt.event.fix(t), l = new Array(arguments.length), u = (Rt.get(this, "events") || {})[a.type] || [], c = gt.event.special[a.type] || {};
            ...
            if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                ...
                a.data = r.data, void 0 !== (i = ((gt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), 
                a.stopPropagation()));
        ...
        handlers: function(t, e) {
            ...
            if (l && u.nodeType && !("click" === t.type && t.button >= 1)) for (;u !== this; u = u.parentNode || this) if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
                for (r = [], s = {}, n = 0; n < l; n++) i = e[n], o = i.selector + " ", void 0 === s[o] && (s[o] = i.needsContext ? gt(o, this).index(u) > -1 : gt.find(o, this, null, [ u ]).length), 
                s[o] && r.push(i);
                r.length && a.push({
                    elem: u,
                    handlers: r
        ...
        stopImmediatePropagation: function() {
            var t = this.originalEvent;
            this.isImmediatePropagationStopped = w, t && !this.isSimulated && t.stopImmediatePropagation(), 
        ...
        gt.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return o && (o === i || gt.contains(i, o)) || (t.type = r.origType, n = r.handler.apply(this, arguments), 
                t.type = e), n;
            }
        };
    }), gt.fn.extend({
    ...
    gt.extend({
        ...
        clone: function(t, e, n) {
            var i, o, r, s, a = t.cloneNode(!0), l = gt.contains(t.ownerDocument, t);
            if (!(dt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || gt.isXMLDoc(t))) for (s = y(a), 
            r = y(t), i = 0, o = r.length; i < o; i++) N(r[i], s[i]);
        ...
        cleanData: function(t) {
            for (var e, n, i, o = gt.event.special, r = 0; void 0 !== (n = t[r]); r++) if (Lt(n)) {
                if (e = n[Rt.expando]) {
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++) 1 === t.nodeType && (gt.cleanData(y(t, !1)), 
            t.textContent = "");
            return this;
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return It(this, function(t) {
                ...
                if ("string" == typeof t && !ee.test(t) && !Qt[(Vt.exec(t) || [ "", "" ])[1].toLowerCase()]) {
                    ...
                    try {
                        for (;n < i; n++) 1 === (e = this[n] || {}).nodeType && (gt.cleanData(y(e, !1)), 
                        e.innerHTML = t);
                        e = 0;
                    } catch (t) {}
                }
        ...
        gt.fn[t] = function(t) {
            for (var n, i = [], o = gt(t), r = o.length - 1, s = 0; s <= r; s++) n = s === r ? this : this.clone(!0), 
            gt(o[s])[e](n), st.apply(i, n.get());
    ...
    !function() {
        function e() {
            if (a) {
                ...
                o = "4px" === e.marginRight, Yt.removeChild(s), a = null;
            }
        }
    ...
    var le = /^(none|table(?!-c[ea]).+)/, ue = /^--/, ce = {
        ...
        letterSpacing: "0",
        fontWeight: "400"
    }, pe = [ "Webkit", "Moz", "ms" ], de = nt.createElement("div").style;
    gt.extend({
        cssHooks: {
            opacity: {
                get: function(t, e) {
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = gt.camelCase(e), l = ue.test(e), u = t.style;
                return l || (e = R(a)), s = gt.cssHooks[e] || gt.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : u[e] : ("string" === (r = typeof n) && (o = Wt.exec(n)) && o[1] && (n = g(t, e, o), 
                r = "number"), void (null != n && n === n && ("number" === r && (n += o && o[3] || (gt.cssNumber[a] ? "" : "px")), 
        ...
        css: function(t, e, n, i) {
            ...
            return ue.test(e) || (e = R(a)), (s = gt.cssHooks[e] || gt.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), 
            void 0 === o && (o = O(t, e, i)), "normal" === o && e in fe && (o = fe[e]), "" === n || n ? (r = parseFloat(o), 
            !0 === n || isFinite(r) ? r || 0 : o) : o;
        }
    }), gt.each([ "height", "width" ], function(t, e) {
        gt.cssHooks[e] = {
            get: function(t, n, i) {
                if (n) return !le.test(gt.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? H(t, e, i) : Ut(t, ce, function() {
                    return H(t, e, i);
                });
            },
            set: function(t, n, i) {
                var o, r = i && ae(t), s = i && P(t, e, i, "border-box" === gt.css(t, "boxSizing", !1, r), r);
                return s && (o = Wt.exec(n)) && "px" !== (o[3] || "px") && (t.style[e] = n, n = gt.css(t, e)), 
                q(t, n, s);
            }
        };
    }), gt.cssHooks.marginLeft = I(dt.reliableMarginLeft, function(t, e) {
        ...
        }, re.test(t) || (gt.cssHooks[t + e].set = q);
    }), gt.fn.extend({
        css: function(t, e) {
            return It(this, function(t, e, n) {
                var i, o, r = {}, s = 0;
                if (Array.isArray(e)) {
                    for (i = ae(t), o = e.length; s < o; s++) r[e[s]] = gt.css(t, e[s], !1, i);
                    return r;
                }
        ...
        init: function(t, e, n, i, o, r) {
            ...
            this.start = this.now = this.cur(), this.end = i, this.unit = r || (gt.cssNumber[n] ? "" : "px");
        },
        cur: function() {
    ...
    gt.Animation = gt.extend(V, {
        tweeners: {
            "*": [ function(t, e) {
                ...
                return g(n.elem, t, Wt.exec(e), n), n;
            } ]
        },
        tweener: function(t, e) {
            gt.isFunction(t) ? (e = t, t = [ "*" ]) : t = t.match(At);
            for (var n, i = 0, o = t.length; i < o; i++) n = t[i], V.tweeners[n] = V.tweeners[n] || [], 
        ...
        stop: function(t, e, n) {
            ...
            this.each(function() {
                var e = !0, o = null != t && t + "queueHooks", r = gt.timers, s = Rt.get(this);
        ...
        finish: function(t) {
            return !1 !== t && (t = t || "fx"), this.each(function() {
                var e, n = Rt.get(this), i = n[t + "queue"], o = n[t + "queueHooks"], r = gt.timers, s = i ? i.length : 0;
        ...
        for (he = gt.now(); e < n.length; e++) (t = n[e])() || n[e] !== t || n.splice(e--, 1);
        ...
        var t = nt.createElement("input"), e = nt.createElement("select").appendChild(nt.createElement("option"));
        t.type = "checkbox", dt.checkOn = "" !== t.value, dt.optSelected = e.selected, (t = nt.createElement("input")).value = "t", 
    ...
    gt.fn.extend({
        ...
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? gt.prop(t, e, n) : (1 === r && gt.isXMLDoc(t) || (o = gt.attrHooks[e.toLowerCase()] || (gt.expr.match.bool.test(e) ? ye : void 0)), 
        ...
        be[e] = function(t, e, i) {
            ...
            return i || (r = be[s], be[s] = o, o = null != n(t, e, i) ? s : null, be[s] = r), 
            o;
        };
    });
    ...
    gt.fn.extend({
        ...
        prop: function(t, e, n) {
            var i, o, r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r) return 1 === r && gt.isXMLDoc(t) || (e = gt.propFix[e] || e, 
            o = gt.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e];
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
        ...
        addClass: function(t) {
            ...
            if ("string" == typeof t && t) for (e = t.match(At) || []; n = this[l++]; ) if (o = Q(n), 
            i = 1 === n.nodeType && " " + X(o) + " ") {
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : gt.isFunction(t) ? this.each(function(n) {
                ...
                var e, i, o, r;
                if ("string" === n) for (i = 0, o = gt(this), r = t.match(At) || []; e = r[i++]; ) o.hasClass(e) ? o.removeClass(e) : o.addClass(e); else void 0 !== t && "boolean" !== n || ((e = Q(this)) && Rt.set(this, "__className__", e), 
                this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : Rt.get(this, "__className__") || ""));
            });
        },
        hasClass: function(t) {
            var e, n, i = 0;
    ...
    gt.fn.extend({
        val: function(t) {
            ...
            "string" == typeof n ? n.replace(Te, "") : null == n ? "" : n)) : void 0;
        }
    }), gt.extend({
        valHooks: {
            option: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var n, i, o = t.options, r = gt.makeArray(e), s = o.length; s--; ) i = o[s], 
    ...
    gt.extend(gt.event, {
        trigger: function(e, n, i, o) {
            var r, s, a, l, u, c, f, p = [ i || nt ], d = ct.call(e, "type") ? e.type : e, h = ct.call(e, "namespace") ? e.namespace.split(".") : [];
            if (s = a = i = i || nt, 3 !== i.nodeType && 8 !== i.nodeType && !Ce.test(d + gt.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), 
            d = h.shift(), h.sort()), u = d.indexOf(":") < 0 && "on" + d, e = e[gt.expando] ? e : new gt.Event(d, "object" == typeof e && e), 
            e.isTrigger = o ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, 
            e.result = void 0, e.target || (e.target = i), n = null == n ? [ e ] : gt.makeArray(n, [ e ]), 
            f = gt.event.special[d] || {}, o || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                if (!o && !f.noBubble && !gt.isWindow(i)) {
                    for (l = f.delegateType || d, Ce.test(l + d) || (s = s.parentNode); s; s = s.parentNode) p.push(s), 
                    a = s;
                    a === (i.ownerDocument || nt) && p.push(a.defaultView || a.parentWindow || t);
                }
                for (r = 0; (s = p[r++]) && !e.isPropagationStopped(); ) e.type = r > 1 ? l : f.bindType || d, 
                (c = (Rt.get(s, "events") || {})[e.type] && Rt.get(s, "handle")) && c.apply(s, n), 
                (c = u && s[u]) && c.apply && Lt(s) && (e.result = c.apply(s, n), !1 === e.result && e.preventDefault());
                return e.type = d, o || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !Lt(i) || u && gt.isFunction(i[d]) && !gt.isWindow(i) && ((a = i[u]) && (i[u] = null), 
                gt.event.triggered = d, i[d](), gt.event.triggered = void 0, a && (i[u] = a)), e.result;
            }
        },
    ...
    }), dt.focusin = "onfocusin" in t, dt.focusin || gt.each({
        focus: "focusin",
        blur: "focusout"
    }, function(t, e) {
        var n = function(t) {
    ...
    var ke = /\[\]$/, De = /\r?\n/g, Ne = /^(?:submit|button|image|reset|file)$/i, Ae = /^(?:input|select|textarea|keygen)/i;
    gt.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !gt(this).is(":disabled") && Ae.test(this.nodeName) && !Ne.test(t) && (this.checked || !zt.test(t));
            }).map(function(t, e) {
                var n = gt(this).val();
    ...
    var je = /%20/g, Oe = /#.*$/, Ie = /([?&])_=[^&]*/, Le = /^(.*?):[ \t]*([^\r\n]*)$/gm, Re = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, qe = /^(?:GET|HEAD)$/, Pe = /^\/\//, He = {}, Fe = {}, We = "*/".concat("*"), Me = nt.createElement("a");
    Me.href = Ee.href, gt.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(e, n) {
            function i(e, n, i, a) {
                var u, p, d, x, w, T = n;
                c || (c = !0, l && t.clearTimeout(l), o = void 0, s = a || "", C.readyState = e > 0 ? 4 : 0, 
                u = e >= 200 && e < 300 || 304 === e, i && (x = Z(h, C, i)), x = tt(h, x, C, u), 
                u ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (gt.lastModified[r] = w), 
                (w = C.getResponseHeader("etag")) && (gt.etag[r] = w)), 204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = x.state, 
                p = x.data, d = x.error, u = !d)) : (d = T, !e && T || (T = "error", e < 0 && (e = 0))), 
                C.status = e, C.statusText = (n || T) + "", u ? v.resolveWith(g, [ p, T, C ]) : v.rejectWith(g, [ C, T, d ]), 
                C.statusCode(b), b = void 0, f && m.trigger(u ? "ajaxSuccess" : "ajaxError", [ C, h, u ? p : d ]), 
                y.fireWith(g, [ C, T ]), f && (m.trigger("ajaxComplete", [ C, h ]), --gt.active || gt.event.trigger("ajaxStop")));
            }
            "object" == typeof e && (n = e, e = void 0), n = n || {};
            var o, r, s, a, l, u, c, f, p, d, h = gt.ajaxSetup({}, n), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? gt(g) : gt.event, v = gt.Deferred(), y = gt.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", C = {
                readyState: 0,
            ...
            if (v.promise(C), h.url = ((e || h.url || Ee.href) + "").replace(Pe, Ee.protocol + "//"), 
            h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(At) || [ "" ], 
            null == h.crossDomain) {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = gt.param(h.data, h.traditional)), 
            K(He, h, n, C), c) return C;
            (f = gt.event && h.global) && 0 == gt.active++ && gt.event.trigger("ajaxStart"), 
            h.type = h.type.toUpperCase(), h.hasContent = !qe.test(h.type), r = h.url.replace(Oe, ""), 
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(je, "+")) : (d = h.url.slice(r.length), 
            h.data && (r += ($e.test(r) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (r = r.replace(Ie, "$1"), 
            d = ($e.test(r) ? "&" : "?") + "_=" + Se++ + d), h.url = r + d), h.ifModified && (gt.lastModified[r] && C.setRequestHeader("If-Modified-Since", gt.lastModified[r]), 
            gt.etag[r] && C.setRequestHeader("If-None-Match", gt.etag[r])), (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && C.setRequestHeader("Content-Type", h.contentType), 
            C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + We + "; q=0.01" : "") : h.accepts["*"]);
            for (p in h.headers) C.setRequestHeader(p, h.headers[p]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, C, h) || c)) return C.abort();
            if (T = "abort", y.add(h.complete), C.done(h.success), C.fail(h.error), o = K(Fe, h, n, C)) {
    ...
    dt.cors = !!Ue && "withCredentials" in Ue, dt.ajax = Ue = !!Ue, gt.ajaxTransport(function(e) {
        var n, i;
        if (dt.cors || Ue && !e.crossDomain) return {
            send: function(o, r) {
                var s, a = e.xhr();
    ...
    gt.ajaxSetup({
        ...
        e.converters["script json"] = function() {
            ...
            void 0 === r ? gt(t).removeProp(o) : t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, 
            _e.push(o)), s && gt.isFunction(r) && r(s[0]), s = r = void 0;
        }), "script";
        ...
        i = e.createElement("base"), i.href = nt.location.href, e.head.appendChild(i)) : e = nt), 
        o = Et.exec(t), r = !n && [], o ? [ e.createElement(o[1]) ] : (o = x([ t ], e, r), 
        r && r.length && gt(r).remove(), gt.merge([], o.childNodes));
    }, gt.fn.load = function(t, e, n) {
        var i, o, r, s = this, a = t.indexOf(" ");
        return a > -1 && (i = X(t.slice(a)), t = t.slice(0, a)), gt.isFunction(e) ? (n = e, 
        ...
        setOffset: function(t, e, n) {
            var i, o, r, s, a, l, u = gt.css(t, "position"), c = gt(t), f = {};
            "static" === u && (t.style.position = "relative"), a = c.offset(), r = gt.css(t, "top"), 
            l = gt.css(t, "left"), ("absolute" === u || "fixed" === u) && (r + l).indexOf("auto") > -1 ? (i = c.position(), 
            s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), gt.isFunction(e) && (e = e.call(t, n, gt.extend({}, a))), 
        ...
        offset: function(t) {
            ...
            return r ? r.getClientRects().length ? (i = r.getBoundingClientRect(), e = r.ownerDocument, 
        ...
        position: function() {
            if (this[0]) {
                ...
                e = this.offset(), o(t[0], "html") || (i = t.offset()), i = {
        ...
        gt.cssHooks[e] = I(dt.pixelPosition, function(t, n) {
            if (n) return n = O(t, e), se.test(n) ? gt(t).position()[e] + "px" : n;
        });
    }), gt.each({
        Height: "height",
        Width: "width"
    ...
    var Ve = t.jQuery, Xe = t.$;
    return gt.noConflict = function(e) {
        return t.$ === gt && (t.$ = Xe), e && t.jQuery === gt && (t.jQuery = Ve), gt;
    }, e || (t.jQuery = t.$ = gt), gt;
}), function(t) {
    "use strict";
    function e() {
    ...
    n.VERSION = "3.3.7", n.TRANSITION_DURATION = 600, n.DEFAULTS = {
        ...
        var u = r[0], c = t.Event("slide.bs.carousel", {
            relatedTarget: u,
            direction: a
        });
